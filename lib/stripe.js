...
export const PLANS = {
  pro_monthly: { key: 'pro_monthly', name: 'DMForge Pro', interval: 'month', amount: 3900, description: '5,000 conversations/mo, LinkedIn, SMS & email, unlimited agents.', features: ['Unlimited AI setters', '5,000 conversations / mo', 'LinkedIn, SMS & Email', 'GoHighLevel booking', 'REST API + MCP'] },
