...
export async function chat({ messages, model = MODEL, temperature = 0.7, max_tokens = 1500, response_format = null, response_schema = null }) {
...
export async function chatJSON({ messages, model = MODEL, temperature = 0.5, max_tokens = 4000, response_schema = null }) {
