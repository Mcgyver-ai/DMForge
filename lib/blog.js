...
export const posts = [
  {
    ...
    category: 'Pillar',
    date: '2026-06-05',
    tldr: 'AI DM setters reply to your Instagram, WhatsApp and Messenger DMs, qualify the lead against your criteria, and book the sales call inside the conversation — no link to paste. Done right, they outperform human setters at 1/20 the cost. Done wrong, they get your account flagged. This is everything you need to set one up properly in 2026.',
    excerpt: 'Everything coaches need to know about AI DM appointment setting in 2026 — what it is, how it works, where it wins over human setters, and the 8 mistakes that get accounts flagged.',
...
Then read [How to make your AI DM bot sound human](/blog/make-ai-dm-bot-sound-human) and [AI vs human setter: the ROI math](/blog/ai-vs-human-setter-roi).`
...

  {
    ...
    title: 'How to automate Instagram DMs in 2026 without getting your account banned',
    category: 'Compliance',
    date: '2026-06-10',
    ...
    excerpt: 'The exact compliance rules behind Instagram DM automation in 2026: which tools are safe, which get accounts flagged, and the 24-hour messaging window every coach needs to know about.',
...
Related: [How to make your AI DM bot sound human](/blog/make-ai-dm-bot-sound-human), [From DM to closed deal: the 5-step funnel](/blog/dm-to-closed-deal-funnel).`
...

  {
    ...
    excerpt: 'Why comment-to-DM is the highest-converting top-of-funnel tactic on Instagram in 2026, and how to set one up properly in under 5 minutes.',
...
Comment-to-DM is the single highest-leverage tactic available to a coach in 2026. It costs nothing to add to your existing content, runs 24/7, and turns reach into booked calls.
