      ...
      <head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({
          '@context':'https://schema.org','@graph':[
            {'@type':'Organization','@id':(process.env.NEXT_PUBLIC_BASE_URL||'https://dmforge.app')+'/#org','name':'DMForge','url':process.env.NEXT_PUBLIC_BASE_URL||'https://dmforge.app','logo':(process.env.NEXT_PUBLIC_BASE_URL||'https://dmforge.app')+'/favicon.ico','sameAs':[]},
            {'@type':'WebSite','@id':(process.env.NEXT_PUBLIC_BASE_URL||'https://dmforge.app')+'/#site','url':process.env.NEXT_PUBLIC_BASE_URL||'https://dmforge.app','name':'DMForge','publisher':{'@id':(process.env.NEXT_PUBLIC_BASE_URL||'https://dmforge.app')+'/#org'}},
